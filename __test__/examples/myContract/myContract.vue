<template>
  <div class="height100">
    ...
    <el-row class="m-t">
      <el-form class="ibox-content" size="mini" ref="queryForm" label-width="120px">
        <div class="ibox-content-title fs14">查询条件</div>
        <el-row justify="space-between">
          <el-col :md="8">
            <el-form-item label="合同类型" prop="CTTYP">
              <search-help :funccode="'00338'" :code.sync="queryData.CTTYP"></search-help>
            </el-form-item>
          </el-col>
          <el-col :md="8">
        ...
        <el-row>
          <el-col :offset="16" :md="8">
            <el-form-item class="clearfix">
              <el-button class="fr" size="mini" @click="restForm('queryForm')">重置</el-button>
              <el-button class="fr mr10" type="primary" size="mini" icon="el-icon-search" @click="queryDataList('Q')">
                查询
              </el-button>
            </el-form-item>
          </el-col>
      ...
      <el-col class="ibox-content">
        <el-tabs v-model="activeName" @tab-click="queryDataList(activeName)">
          <el-tab-pane label="劳动合同" name="X">
            ...
            >
              <el-table-column
                ...
                sortable
              ></el-table-column>
              <el-table-column prop="CTTYP" label="合同类型" align="center" sortable></el-table-column>
              <el-table-column
                prop="ZZHTQXLX"
                label="期限类型"
                align="center"
                sortable
              ></el-table-column>
              <el-table-column prop="ZHTQX" label="合同期限" align="center" sortable></el-table-column>
              <el-table-column prop="ZZHTQDZTI" label="合同主体" align="center" sortable></el-table-column>
              <el-table-column
                prop="BEGDA"
                label="合同开始日期"
                width="140px"
              ...
              <el-table-column
                ...
                sortable
              ></el-table-column>
              <el-table-column prop="PRBZT" label="试用期" align="center" sortable></el-table-column>
              <el-table-column
                prop="ZZHTZZRQ"
                label="试用结束日期"
                width="140px"
                ...
                sortable
              ></el-table-column>
              <el-table-column prop="ZSTAT" label="状态" align="center" sortable></el-table-column>
              <el-table-column label="操作" align="center" fixed="right">
                <template slot-scope="scope">
                  ...
                  <el-button class="text-primary" size="mini" type="text" @click="toDetail(scope.row)">
                    查看
                  </el-button>
                </template>
              </el-table-column>
          ...
          <el-tab-pane label="已办列表" name="" v-if="false">
            <table-util
              :search-content.sync="searchContent2"
              :id="'done'"
              :currentPage.sync="currentPage"
              :pageSize.sync="pageSize"
              :tableData="tableData"
            ...
            >
              ...
              >
                <template slot-scope="scope">
                  <a class="text-success m-r-xs" size="mini" @click="toDetail(scope.row)">{{ scope.row.TITLE }}</a>
                </template>
              </el-table-column>
              <el-table-column
                show-overflow-tooltip
              ...
              <el-table-column
                ...
                :formatter="formatterDate"
              ></el-table-column>
              <el-table-column prop="PROTT" label="处理状态" align="center" sortable></el-table-column>
              <el-table-column
                show-overflow-tooltip
                prop="ENAME"
                label="提交人"
...
export default {
  ...
  data() {
    return {
      ...
      tableField2: ["index", "TITLE", "ZTEXT", "ZTEXT", "RECDT", "PRODT", "PROTT", "ENAME"],
      dialogVisible: false,
      parentData: {},
    }
  },
  methods: {
    ...
    queryDataList(status) {
      ...
      params.IV_BEGDA = this.queryData.BEGDA ? new Date(this.queryData.BEGDA).Format("yyyyMMdd") : ""
      params.IV_ENDDA = this.queryData.ENDDA ? new Date(this.queryData.ENDDA).Format("yyyyMMdd") : ""
    ...
    downDetail(row) {
      if (row.ZHTWJ.indexOf("https") !== -1) {
        ...
        window.open(
          `dhrDownloadService/aliyunoss/download?ossPath=${row.ZHTWJ}&fileName=${"劳动合同.pdf"}`,
        )
      }
    },
    /**
    ...
    ossPreview(ossPath) {
      ...
      this.$httpServer.file.aliPreviewFile({
          ossPath: ossPath,
