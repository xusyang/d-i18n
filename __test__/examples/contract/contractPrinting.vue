<!--
Description: 事件批量导入
   1、当前文件的路径 src/views/pa/personnelEvent/contractPrinting.vue
...
<template>
  <div v-loading.fullscreen="loading" :element-loading-text="'加载中.....'">
    ...
    <div class="ibox-content mt10 contract-box">
      <el-form size="mini" :model="pageForm" ref="pageForm" :rules="rules" label-width="200px" label-position="top">
          ...
          <el-row class="paddl10">
            <el-col class="el-col-sm-6">
              <el-form-item prop="ZLDHTMB" label="劳动合同模版">
                <el-select v-model="pageForm.ZLDHTMB" :disabled="isEdit" class="width90p">
                  <el-option
          ...
          <el-row class="paddl10">
            ...
            <el-col class="el-col-sm-6">
              <el-form-item prop="ZFR_NAME" label="法定代表人（主要负责人）">
                <el-input v-model="pageForm.ZFR_NAME" :disabled="isEdit" class="width90p"></el-input>
              </el-form-item>
            </el-col>
            <el-col class="el-col-sm-6">
            ...
            <el-col class="el-col-sm-6">
              <el-form-item prop="ZTXDZ_DW" label="通讯地址">
                <el-input v-model="pageForm.ZTXDZ_DW" :disabled="isEdit" class="width90p"></el-input>
              </el-form-item>
            </el-col>
            <el-col class="el-col-sm-6">
            ...
            <el-col class="el-col-sm-6">
              <el-form-item prop="ZPHONE_DW" label="电话号码">
                <el-input v-model="pageForm.ZPHONE_DW" :disabled="isEdit" class="width90p"></el-input>
              </el-form-item>
            </el-col>
            <el-col class="el-col-sm-6">
          ...
          <el-row class="paddl10">
            <el-col class="el-col-sm-6">
              <el-form-item prop="ENAME" label="姓名">
                <el-input v-model="pageForm.ENAME" class="width90p" disabled></el-input>
              </el-form-item>
            </el-col>

            <el-col class="el-col-sm-6">
              <el-form-item prop="ICNUM" label="身份证号">
                <el-input v-model="pageForm.ICNUM" class="width90p" disabled></el-input>
              </el-form-item>
            </el-col>

            <el-col class="el-col-sm-6">
              <el-form-item prop="ZHJDZ" label="户籍地址">
                <el-input v-model="pageForm.ZHJDZ" class="width90p" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col class="el-col-sm-6">
              <el-form-item prop="ZTXDZ_GR" label="通讯地址">
                <el-input v-model="pageForm.ZTXDZ_GR" class="width90p" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col class="el-col-sm-6">
              <el-form-item prop="ZPHONE_GR" label="联系电话">
                <el-input v-model="pageForm.ZPHONE_GR" class="width90p" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col class="el-col-sm-6">
              <el-form-item prop="ZEMAIL_GR" label="邮箱地址">
                <el-input v-model="pageForm.ZEMAIL_GR" class="width90p" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <div class="">
          ...
          <el-row class="paddl10">
            <el-col class="el-col-sm-6">
              <el-form-item prop="ZZHTQXLX_T" label="合同期限类型">
                <el-input v-model="pageForm.ZZHTQXLX_T" class="width90p" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col class="el-col-sm-6">
              <el-form-item prop="BEGDA" label="合同开始日期">
                <el-input v-model="pageForm.BEGDA" class="width90p" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col class="el-col-sm-6">
              <el-form-item prop="CTEDT" label="合同结束日期">
                <el-input v-model="pageForm.CTEDT" class="width90p" disabled></el-input>
              </el-form-item>
            </el-col>
            <div class="col-md-4" v-if="pageForm.ZZHTQXLX === '03'">
              <el-form-item prop="ZHTZZBZ" label="合同终止标志">
                <el-input v-model="pageForm.ZHTZZBZ" class="width90p" :disabled="isEdit"></el-input>
              </el-form-item>
            </div>
            <el-col class="el-col-sm-6">
              <el-form-item prop="ZSFSY" label="是否有试用期限">
                <el-input v-model="pageForm.ZSFSY" class="width90p" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col class="el-col-sm-6">
              <el-form-item prop="ZZSYKSRQ" label="试用期开始日期">
                <el-input v-model="pageForm.ZZSYKSRQ" class="width90p" disabled></el-input>
              </el-form-item>
            </el-col>
            <el-col class="el-col-sm-6">
              <el-form-item prop="ZZHTZZRQ" label="试用期结束日期">
                <el-input v-model="pageForm.ZZHTZZRQ" class="width90p" disabled></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <div class="">
          ...
          <el-row class="paddl10">
            <el-col class="el-col-sm-24">
              <el-form-item prop="ZGZDD" label="乙方工作地点">
                <el-input v-model="pageForm.ZGZDD" :disabled="isEdit" class="width-97-5"></el-input>
              </el-form-item>
            </el-col>
            <el-col class="el-col-sm-6">
            ...
            <el-col class="el-col-sm-6">
              <el-form-item prop="ZGZNR_M" label="乙方工作内容">
                <el-input v-model="pageForm.ZGZNR_M" :disabled="isEdit"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row class="paddl10">
            ...
            <el-col class="el-col-sm-6" v-if="pageForm.ZGZZ != 2">
              <el-form-item prop="ZGZZJSZQ" label="工作制计算周期（综合计算工时工作制）">
                <search-help
                  funccode="HT002"
                  :code.sync="pageForm.ZGZZJSZQ"
                  :text.sync="pageForm.ZGZZJSZQ_T"
                  :disabled="isEdit"
                  class="width90p"
                ></search-help>
              </el-form-item>
          ...
          <el-row class="paddl10">
            ...
            <el-col class="el-col-sm-6">
              <el-form-item prop="ZJSGZ" label="计时工资（元/月）">
                <el-input v-model="pageForm.ZJSGZ" :disabled="isEdit" class="width90p"></el-input>
              </el-form-item>
            </el-col>
            <el-col class="el-col-sm-6">
              <el-form-item prop="ZSYQGZ" label="试用期工资（元/月）">
                <el-input v-model="pageForm.ZSYQGZ" :disabled="isEdit" class="width90p"></el-input>
              </el-form-item>
            </el-col>
            <el-col class="el-col-sm-6">
              <el-form-item prop="ZFXR" label="发薪日（每月_日）">
                <el-input v-model="pageForm.ZFXR" :disabled="isEdit" class="width90p"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
...
export default {
  ...
  components: { PaSearchUser, SendEmail },
  data() {
    return {
      pageForm: {
        ZLDHTMB: "",
  ...
  methods: {
        ...
        if (msg.MSGTY === "S") {
          ...
          this.pageForm.ZHTZZBZ =
            !es_output.ZHTZZBZ && this.pageForm.ZZHTQXLX === "03"
              ? "已完成一定的工作为期限"
              : ""
          this.pageForm.ZLDHTMB = this.$isEmpty(es_output.ZLDHTMB) ? " " : es_output.ZLDHTMB
          ...
          this.pageForm.ZFXR = this.$isEmpty(es_output.ZFXR) ? "6" : es_output.ZFXR
          //用章人
              ...
              if (this.baseParams.paContractList.EMAIL) {
                if (this.pageForm.ZZSYKSRQ && this.pageForm.ZZHTZZRQ) {
                  this.pageForm.SYQ = this.MonthsBetw(
                    this.pageForm.ZZSYKSRQ.replace(/(\d{4})(\d{2})(\d{2})/g, "$1-$2-$3"),
                    this.pageForm.ZZHTZZRQ.replace(/(\d{4})(\d{2})(\d{2})/g, "$1-$2-$3"),
                  )
                } else {
                  this.pageForm.SYQ = ""
                }
    ...
    getDynamicTemplate() {
      ...
      let params = {}
      wordData.HTBH = "YXDC-HT-" + this.$formatDate(this.pageForm.BEGDA, "num") + "-" + this.baseParams.PERNR
      ...
      //试用期结束日期有值就是2没值就是1
      wordData.SYQDJZFS = this.pageForm.ZZHTZZRQ !== "00000000" && this.pageForm.ZZHTZZRQ ? 2 : 1 //试用期限双方同意按以下第
      wordData.SYQNKS = this.returnSlash(this.$formatDate(this.pageForm.ZZSYKSRQ, "Y")) //试用期开始年
      wordData.SYQYKS = this.returnSlash(this.$formatDate(this.pageForm.ZZSYKSRQ, "M")) //试用期开始月
      wordData.SYQRKS = this.returnSlash(this.$formatDate(this.pageForm.ZZSYKSRQ, "D")) //试用期开始日
      wordData.SYQNJS = this.returnSlash(this.$formatDate(this.pageForm.ZZHTZZRQ, "Y")) //试用期结束年
      wordData.SYQYJS = this.returnSlash(this.$formatDate(this.pageForm.ZZHTZZRQ, "M")) //试用期结束月
      wordData.SYQRJS = this.returnSlash(this.$formatDate(this.pageForm.ZZHTZZRQ, "D")) //试用期结束日
     ...
     */
    backing() {
      this.$router.push({ path: "/ht/event/", query: { MENUII: this.baseParams.MENUII } })
    },
    /**
     * @Copyright  DELOITTE
     * @Description: 查询员工回调
    ...
    settingRules() {
      for (let i in this.pageForm) {
        this.rules[i] = [
          { required: true, trigger: "blur", message: "该项为必填" },
        ]
      }
    },
    /**
     ...
     */
    getZZHTQDDWData() {
      this.$httpServer.sap.getDicts({ type: "HT006" }).then(res => {
    ...
    getPdf(state) {
      this.$refs["pageForm"].validate((valid) => {
        if (valid) {
          ...
          //如果是有固定期限，那么固定期限和工作为期限的开始日期和结束日期都是/
          if (this.pageForm.ZZHTQXLX === "01") {
            wordData.YGDQXNA = this.returnSlash(this.$formatDate(this.pageForm.BEGDA, "Y")) //有固定期限年
            wordData.YGDQXYA = this.returnSlash(this.$formatDate(this.pageForm.BEGDA, "M")) //有固定期限月
            wordData.YGDQXRA = this.returnSlash(this.$formatDate(this.pageForm.BEGDA, "D")) //有固定期限日
            wordData.YGDQXNB = this.returnSlash(this.$formatDate(this.pageForm.CTEDT, "Y")) //有固定期限结束年
            wordData.YGDQXYB = this.returnSlash(this.$formatDate(this.pageForm.CTEDT, "M")) //有固定期限结束月
            wordData.YGDQXRB = this.returnSlash(this.$formatDate(this.pageForm.CTEDT, "D")) //有固定期限结束日
          ...
          if (this.pageForm.ZZHTQXLX === "02") {
            ...
            wordData.WGDQXNA = this.returnSlash(this.$formatDate(this.pageForm.BEGDA, "Y")) //无固定期限年
            wordData.WGDQXYA = this.returnSlash(this.$formatDate(this.pageForm.BEGDA, "M")) //无固定期限月
            wordData.WGDQXRA = this.returnSlash(this.$formatDate(this.pageForm.BEGDA, "D")) //无固定期限日
          ...
          if (this.pageForm.ZZHTQXLX === "03") {
            ...
            wordData.WGDQXYA = "/" //无固定期限月
            wordData.WGDQXRA = "/" //无固定期限日
            wordData.GZQXN = this.returnSlash(this.$formatDate(this.pageForm.BEGDA, "Y")) //工作期限年
            wordData.GZQXY = this.returnSlash(this.$formatDate(this.pageForm.BEGDA, "M")) //工作期限月
            wordData.GZQXR = this.returnSlash(this.$formatDate(this.pageForm.BEGDA, "D")) //工作期限日
          }
          //工作标志
    ...
    getContract() {
      if (this.pageForm.ZHTWJ.indexOf("https") !== -1) {
        ...
        window.open(
          `dhrDownloadService/aliyunoss/download?ossPath=${this.pageForm.ZHTWJ}&fileName=${
            "劳动合同" + ".pdf"
          }`,
        )
      }
