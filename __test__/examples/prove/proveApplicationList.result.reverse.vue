            ...
            <el-col class="el-col-sm-8">
              ...
              >
                <search-help
                  funccode="90005"
                  :initcond="
                    baseParams.MENUII === pageCode.ZMGL ? 'ZZHR' : 'ZZEE'
                  "
                  :code.sync="pageData.zmlx"
                  :text="pageData.zmlx_t"
                  class="width90p"
                ></search-help>
              </el-form-item>
            </el-col>
            ...
            >
              <template slot-scope="scope">
                <template>
                  <el-link
                    @click.native="
                      $previewFile(scope.row.FILEID, scope.row.FILENAME)
                    "
                  ...
                  <el-link
                    @click.native="
                      $downloadFile(scope.row.FILEID, scope.row.FILENAME)
                    "
                    v-show="scope.row.ZSTAT === '5' || scope.row.ZSTAT === '7'"
                    type="warning"
                    size="mini"
  ...
  methods: {
    ...
    newApplication() {
      ...
      if (
        ...
        this.baseParams.MENUII === this.pageCode.ZMGL
      )
        return
    ...
    handleCellStyle({ row, column, rowIndex, columnIndex }) {
      ...
      if (
        ...
        (row.ZSTAT === '4' || row.ZSTAT === '5' || row.ZSTAT === '6')
      ) {
