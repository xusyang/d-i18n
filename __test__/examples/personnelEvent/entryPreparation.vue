 ...
 * @Date: 2021-04-29 14:31:47
 * @LastEditTime: 2022-04-20 19:40:01
 * @Email:
 * @FilePath: \dhr-web\src\views\pa\personnelEvent\entryPreparation.vue
 * @Environment:
 * @Description: 入职准备独立详情文件
-->
            ...
            <el-row>
              <el-col class="el-col-sm-12" style="height: 35px">
                <el-form-item label="员工姓名：">
                  <strong>{{ headerDataListStruce.params.ENAME }}</strong>
                </el-form-item>
              </el-col>
              <el-col class="el-col-sm-12" style="height: 35px">
                <el-form-item label="岗位：">
                  <strong>{{ headerDataListStruce.params.POS_STEXT }}</strong>
                </el-form-item>
              </el-col>
              <el-col class="el-col-sm-12" style="height: 35px">
                <el-form-item label="组织单位：">
                  <strong>{{ headerDataListStruce.params.ORG_STEXT }}</strong>
                </el-form-item>
              </el-col>
              <!-- <el-col class="el-col-sm-12" style="height: 35px">
                <el-form-item label="员工组：">
                  <strong>{{ headerDataListStruce.params.PTEXT }}</strong>
                </el-form-item>
              </el-col>
              <el-col class="el-col-sm-12" style="height: 35px">
                <el-form-item :label="'职级（衔）' + '：'">
                  <strong>{{ headerDataListStruce.params.ZE_ZZZXT }}</strong>
                </el-form-item>
              </el-col> -->
              <el-col class="el-col-sm-12" style="height: 35px">
                <el-form-item label="拟报到日期：">
                  <strong>{{ headerDataListStruce.params.BEGDA }}</strong>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
              ...
              <div>
                <div class="main-content-box">
                  <h4 class="clearfix m-t-md">
                    <span class="li-bg-blue"></span>人事事件
                  </h4>
                  <hr />
                  ...
                  >
                    <h4 class="clearfix m-t-md">
                      <span class="li-bg-blue"></span>办理事项
                    </h4>
                    <hr />
                    <div class="infoType-content-box">
                      <el-row>
                          ...
                          <!-- <el-col :md="5">
                            ...
                            <el-form-item>
                              <search-help
                                ...
                                :funccode="'PA701'"
                                :disabled="isEntry === '1'"
                                :code.sync="headerDataListStruce.params.ZTERF"
                              ></search-help>
                            </el-form-item>
                          </el-col>
                          <el-col :md="5">
                            ...
                            <el-form-item>
                              <el-select
                                style="width: 95%"
                                :disabled="isEntry === '1'"
                                v-model="headerDataListStruce.params.SCHKZ"
                              >
                                <el-option v-for="item in BCOptions" :key="item.KEY" :label="item.VALUE" :value="item.KEY"></el-option>
                              </el-select>
                            </el-form-item>
                          </el-col> -->
                          <el-col>
                  ...
                  >
                    ...
                    <h4 class="clearfix m-t-md">
                      <span class="li-bg-blue"></span>候选人信息
                    </h4>
                    <hr />
                    <div class="infoType-content-box">
                      <el-row :gutter="24">
                        <div>
                          <!-- <el-col :md="6">
                            ...
                            <el-form-item>
                              <el-input
                                :disabled="isEntry === '1'"
                                v-model="headerDataListStruce.params.ZAD_NUMBER"
                              ></el-input>
                            </el-form-item>
                          </el-col>
                          <el-col :md="6">
                            ...
                            <el-form-item>
                              <el-input
                                :disabled="isEntry === '1'"
                                v-model="headerDataListStruce.params.ZEMAIL_COM"
                              ></el-input>
                            </el-form-item>
                          </el-col>
                          <el-col :md="6">
                            ...
                            <el-form-item>
                              <el-input
                                :disabled="isEntry === '1'"
                                v-model="headerDataListStruce.params.ZEMAIL_COM_XC"
                              ></el-input>
                            </el-form-item>
                          </el-col> -->
                          <el-col :md="6">
                          ...
                          <!--  <el-col :md="6">
                            ...
                            <el-form-item>
                              <search-help :funccode="'PA030'" :disabled="true"
                                           :code.sync="headerDataListStruce.params.ZDNXH"></search-help>
                            </el-form-item>
                          </el-col> -->
                        </div>
                      </el-row>
  ...
  methods: {
    ...
    getBCOptions(ZBASE) {
      const params = {
        sapInterface: 'PA054',
        IV_DATUM: new Date().Format('yyyyMMdd'),
        IT_SHH_CONDITION: JSON.stringify([{ FIELD: 'ZBASE', VALUE: ZBASE }])
      }
