<!--
 * @Date: 2021-04-25 09:49:39
 * @LastEditTime: 2021-07-06 18:07:44
 * @Email:
 * @FilePath: /dhr-web/src/views/pa/personnelEvent/selectEntryTemplate.vue
 * @Environment:
 * @Description:
-->
<template>
  ...
  methods: {
    ...
    buttonEvent(param) {
      if (param.FUNC === "FC10") {
        ...
        this.$router.push({ path: "/pa/getFileds", query: param })
      }
    },
  },
  created() {
