...
const visibleNumber = ref(null) // 是否为首次加载

const isFrist = ref(null) // 当前激活菜单的 index

const currentIndex = ref(null)
const store = useStore()
const route = useRoute()
const router = useRouter() // 主题颜色

const theme = computed(() => store.state.settings.theme) // 所有的路由信息
