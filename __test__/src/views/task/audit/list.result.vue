  ...
  <LayoutContentV>
    <template #query>
      <el-form
        ...
        :inline="true"
      >
        <el-form-item :label="I18N.$fanyi('待审核内容')" prop="name">
          <el-select
            v-model="queryData.guid"
        ...
        <el-form-item :label="I18N.$fanyi('名称')" prop="processTitle">
          <el-input
            v-model="queryData.processTitle"
            :placeholder="I18N.$fanyi('请输入')"
            clearable
          />
        </el-form-item>
        <el-form-item :label="I18N.$fanyi('申请人')" prop="applyUserName">
          <el-input
            v-model="queryData.applyUserName"
            :placeholder="I18N.$fanyi('请输入')"
            clearable
          />
        </el-form-item>
        <el-form-item
          :label="I18N.$fanyi('审核状态')"
          prop="agree"
          v-if="currentTab === 'did'"
        >
          <el-select
            v-model="queryData.agree"
            :placeholder="I18N.$fanyi('请选择')"
            clearable
          >
            <el-option
              v-for="item in agreeStatus"
              :key="item.value"
              :label="item.label"
              :value="item.value"
            />
        ...
        >
          <el-date-picker
            ...
            :start-placeholder="I18N.$fanyi('开始时间')"
            :end-placeholder="I18N.$fanyi('结束时间')"
          ></el-date-picker>
        </el-form-item>
