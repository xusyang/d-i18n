    ...
    <template #query>
      ...
      >
        <el-form-item :label="I18N.$fanyi('菜单名称')" prop="menuName">
          <el-input
            v-model="queryData.menuName"
            :placeholder="I18N.$fanyi('请输入菜单名称')"
            clearable
            @keyup.enter="handleQuery"
          />
        </el-form-item>
        <el-form-item :label="I18N.$fanyi('菜单状态')" prop="status">
          <el-select
            v-model="queryData.status"
            :placeholder="I18N.$fanyi('菜单状态')"
            clearable
          >
            <el-option
...
const tableColumns = reactive<IDTableColumn[]>([
  ...
  {
    prop: 'perms',
    label: I18N.$fanyi('权限标识'),
    align: 'center',
    showOverflowTooltip: true
  },
  {
    prop: 'component',
    label: I18N.$fanyi('组件路径'),
    align: 'center',
    showOverflowTooltip: true
  },
  {
    prop: 'path',
    label: I18N.$fanyi('路由地址'),
    align: 'center',
    showOverflowTooltip: true
  },
  {
