<template>
  <el-dialog :title="title" v-model="show" width="680px" :before-close="cancel" append-to-body>
    <el-form ref="refMenu" :model="formData" :rules="formRules" label-width="100px">
      <el-row>
        <el-col :span="24">
        ...
        <el-col :span="24" v-if="formData.menuType != 'F'">
          <el-form-item label="菜单图标" prop="icon">
            ...
            >
              <template #reference>
                <el-input v-model="formData.icon" placeholder="点击选择图标" @click="showSelectIcon" readonly>
                  <template #prefix>
                    <svg-icon
                      v-if="formData.icon"
...
import { getCurrentInstance, reactive, computed, defineExpose, ref, toRefs, toRaw } from 'vue'
