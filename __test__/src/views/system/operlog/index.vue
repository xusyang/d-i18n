  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="业务类型" prop="businessType">
        <el-select v-model="queryParams.businessType" placeholder="业务类型" clearable style="width: 240px">
    ...
    <el-row :gutter="10" class="mb8" style="min-height: 35px">
      ...
      <el-col :span="1.5">
        <el-button plain @click="handleClean" v-hasPermi="['monitor:operlog:remove']">
          清空
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button plain @click="handleExport" v-hasPermi="['monitor:operlog:export']">
          导出
        </el-button>
      </el-col>
