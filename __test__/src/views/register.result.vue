...
const registerRules = {
  username: [
    ...
    },
    {
      min: 2,
      max: 20,
      message: I18N.$fanyi('用户账号长度必须介于 2 和 20 之间'),
      trigger: 'blur'
    }
  ],
  password: [
