  ...
  <div class="app-container">
    ...
    <LayoutTableH #content="{ height }">
      ...
      >
        ...
        >
          <template #default="scope">
            <el-tooltip :content="I18N.$fanyi('预览')" placement="top">
              <el-button
                type="text"
                icon="View"
            ...
            <el-tooltip :content="I18N.$fanyi('编辑')" placement="top">
              <el-button
                type="text"
                icon="Edit"
            ...
            <el-tooltip :content="I18N.$fanyi('同步')" placement="top">
              <el-button
                type="text"
                icon="Refresh"
            ...
            <el-tooltip :content="I18N.$fanyi('生成代码')" placement="top">
              <el-button
                type="text"
                icon="Download"
...
function handleGenTable(row) {
  ...
  if (tbNames == '') {
    proxy.$modal.msgError(I18N.$fanyi('请选择要生成的数据'))
    return
  }
  ...
  if (row.genType === '1') {
    genCode(row.tableName).then((response) => {
      proxy.$modal.msgSuccess(
        I18N.$fanyi('成功生成到自定义路径：') + row.genPath
      )
    })
  } else {
