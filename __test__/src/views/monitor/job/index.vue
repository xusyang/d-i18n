<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" @click="handleAdd" v-hasPermi="['monitor:job:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          type="primary"
      ...
      <el-col :span="1.5">
        <el-button plain @click="handleExport" v-hasPermi="['monitor:job:export']">
          导出
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button plain @click="handleJobLog" v-hasPermi="['monitor:job:query']">
          日志
        </el-button>
      </el-col>
    ...
    <LayoutTableH #content="{ height }">
      <el-table v-loading="loading" :data="jobList" @selection-change="handleSelectionChange" :max-height="height">
