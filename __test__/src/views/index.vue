...
const allocExecuteData = reactive([
  { name: '执行中', value: 0, icon: 'zhihangzhong' },
  { name: '已完成', value: 0, icon: 'yiwancheng' },
  { name: '未开始', value: 0, icon: 'weikaishi' }
])

const allocResultData = reactive([
  { name: '分摊差额异常', value: 0, icon: 'yichang', route: '442' },
  { name: '被承接差额异常', value: 0, icon: 'yichang', route: '442' }
])

const quickAccessData = reactive([
  { name: '基础维度管理', value: '320', icon: 'jcwd' },
  { name: '费用单据', value: '426', icon: 'feiyongdanju' },
  { name: '动因定义', value: '360', icon: 'dongyindingyi' },
  { name: '分摊动因', value: '344', icon: 'fentandongyin' },
  { name: '影响因素', value: '368', icon: 'yingxiangyinsu' },
  { name: '分摊方案', value: '352', icon: 'fentanfangan' },
  { name: '分摊执行', value: '406', icon: 'ftzx' },
  { name: '预制报表', value: '430', icon: 'yuzhibaobiao' }
])
